...
Early-career AI/ML & Software Engineer specializing in the intersection of Artificial Intelligence (Computer Vision & Speech/Audio) and robust backend architecture. I focus on moving complex models from research into scalable, production-ready systems, with a strong emphasis on balancing latency, cost, and accuracy in production AI. Software Engineer with a B.Sc. in Electrical and Computer Engineering from North South University, specializing in Artificial Intelligence (Major), full-stack development, systems architecture, and applied Algorithms and Computation (Minor). I focus on building scalable, thresholdable applications and moving difficult ideas from academic or roundtable research into production environments.
